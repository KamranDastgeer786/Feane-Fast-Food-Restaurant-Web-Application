												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="manuName"
															id="manuName" placeholder="Product Name">
													</div>
												</div>
												<!--/span-->
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="ingredients"
															id="ingredients" placeholder="Lorem Ipsum Text...">
													</div>
												</div>
												<!--/span-->
											</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select class="form-select" name="categoryName"
															id="categoryName" data-placeholder="Choose a Category">
...
<!-- Mirrored from riday-admin-template.multipurposethemes.com/bs5/main-mini/add_new_menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 12:30:16 GMT -->
